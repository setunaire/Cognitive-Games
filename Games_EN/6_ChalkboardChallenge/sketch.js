...
const FAM_PRACTICE_SETS = [
  [ // set A — every trial inside its level's diff-ratio band
    [ famT([42, 14], ['+'], 56,        [19, 16], ['+'], 35) ],
    [ famT([25, 14, 9], ['+', '-'], 30, [47, 8], ['-'], 39),
      famT([8, 3, 7], ['+', '*'], 29,   [24, 12], ['+'], 36) ],
    [ famT([48, 6, 19], ['/', '+'], 27, [5, 6, 6], ['*', '-'], 24) ]
  ],
  [ // set B
    [ famT([17, 21], ['+'], 38,         [33, 26], ['+'], 59) ],
    [ famT([52, 17, 6], ['-', '+'], 41, [13, 19], ['+'], 32),
      famT([31, 7], ['-'], 24,          [5, 4, 6], ['+', '*'], 29) ],
    [ famT([54, 9, 22], ['/', '+'], 28, [7, 4, 3], ['*', '-'], 25) ]
  ]
];
