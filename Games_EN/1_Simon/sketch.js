/* ============================================================================
   SIMON TASK — Assessment Phase (English version)
...
/* ============================================================================
   ...
   ========================================================================== */
const STRINGS = {
  gameTitle: 'Simon Task',
  gameSubtitle: 'Respond to the meaning of the word — not its position',
  ...
  words: { left: 'LEFT', right: 'RIGHT', center: 'CENTER', up: 'UP', down: 'DOWN' },

  // Instructions
  levelLabel: 'Level',
  ofLabel: 'of',
  instructionsCommon:
    'A direction word will appear somewhere on the screen.\n' +
    'Press the arrow key that matches the MEANING of the word,\n' +
    'no matter where the word appears.',
  keyHints: {
  ...
  // HUD — {i} current trial, {n} total, {t} remaining time
  hudTrial: 'Trial: {i} / {n}',
  hudTime: 'Time: {t}',
  ...
  famAnswerKey: 'Correct key: {a}',
  famDemos: [
    'The word says LEFT — press ← ,\neven though it appears on the RIGHT. Only the MEANING matters, never the position.',
    'The word says RIGHT — press → ,\neven though it appears on the LEFT. Again: follow the WORD, not where it is.',
    'New at this level: the word CENTER — press ↓ .',
    'New keys at this level: UP = ↑ and DOWN = ↓ .\n(↓ now means DOWN, not CENTER.)'
  ],
