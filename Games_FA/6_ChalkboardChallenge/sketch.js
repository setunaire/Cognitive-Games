...
const STRINGS = {
  ...
  famAnswerValues: 'چپ = {l}        راست = {r}',
  famDemos: [
    'دو عبارت نمایش داده می‌شود — تشخیص دهید کدام سمت بزرگ‌تر است.\nچپ: \u2066۴۷ + ۵ = ۵۲\u2069.  راست: \u2066۳۵ + ۴۵ = ۸۰\u2069 — کلید →.',
    '× و ÷ قبل از + و − محاسبه می‌شوند.\n\u2066۱۲ + ۷ × ۳\u2069 : اول \u2066۷ × ۳ = ۲۱\u2069 ، سپس \u2066۱۲ + ۲۱ = ۳۳\u2069. راست: ۴۲ — کلید →.'
  ],
};
